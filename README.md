...
Votes are counted on the Queen's voting comment. Outcomes are evaluated in priority order — a signal only wins if it clears its threshold:

| Signal | Outcome | Threshold |
|---|---|---|
